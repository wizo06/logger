...
module.exports.createPrintString = (printHostname, printUNIXTimestamp, printHumanReadableTimestamp, stackDepth, printFileName, printLineNumber, printLogLevel, logLevel, data) => {
  const msg = [];
  ...
  if (printFileName) {
    msg.push(`[${getCaller(stackDepth, printLineNumber)}]`);
  }
  ...
  if (data instanceof Object) {
    msg.push(inspect(data, false, null, true));
  } else {
    msg.push(data);
  }
...
const getCaller = (stackDepth, lineNumber) => {
